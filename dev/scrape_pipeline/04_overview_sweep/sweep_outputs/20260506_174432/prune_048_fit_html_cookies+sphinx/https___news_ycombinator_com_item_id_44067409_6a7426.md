...
| --- |  
| 418 points by kepano 11 months ago | hide | past | favorite | 68 comments |  
...
| --- |  
 |  
|   
 | https://help.obsidian.md/basesNote that I'm using a preview (catalyst) version, it will reach stable soon. I'm assuming kepano will submit it here then. |  
| --- |  
 |  
|   
...
| --- |  
 |  
 |  
| Consider applying for YC's Summer 2026 batch! Applications are open till May 4Guidelines | FAQ | Lists | API | Security | Legal | Apply to YC | Contact |
