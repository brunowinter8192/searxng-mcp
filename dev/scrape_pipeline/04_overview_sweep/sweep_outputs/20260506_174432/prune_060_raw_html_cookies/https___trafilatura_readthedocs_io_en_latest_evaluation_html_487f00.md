...
System Settings
[Private repos, priority support, SSO, custom builders.**Check our Read the Docs Enterprise plans**](https://server.ethicalads.io/proxy/click/8335/019dfdf9-b839-7a12-8901-2ee8c0764f74/)
[ℹ️](https://www.ethicalads.io/advertisers/topics/data-science/?ref=rtd-sidebar-buy-ads)
...
| _raw HTML_  | 0.527  | 0.874  | 0.546  | 0.658  |  
| html2text 2020.1.16  | 0.486  | 0.709  | 0.481  | 0.577  | 7.6x  |  
| html_text 0.5.2  | 0.529  | 0.554  | 0.682  | 2.2x  |  
| inscriptis 2.2.0 (html to txt)  | 0.534  | 0.563  | 0.686  | 3.5x  |  
| newspaper3k 0.2.8  | 0.895  | 0.593  | 0.762  | 0.713  |  
| justext 3.0.0 (custom)  | 0.865  | 0.650  | 0.775  | 0.742  | 5.2x  |  
| boilerpy3 1.0.6 (article mode)  | 0.814  | 0.744  | 0.787  | 0.777  | 4.1x  |  
| _baseline (text markup)_  | 0.757  | 0.827  | 0.781  | 0.790  |  
| goose3 3.1.9  | 0.690  | 0.821  | 0.793  |  
| readability-lxml 0.8.1  | 0.891  | 0.729  | 0.820  | 0.801  | 5.8x  |  
| news-please 1.5.22  | 0.898  | 0.734  | 0.826  | 0.808  |  
| readabilipy 0.2.0  | 0.877  | 0.870  | 0.874  | 0.874  | 248x  |  
| trafilatura 1.2.2 (fast)  | 0.914  | 0.886  | 0.902  | 0.900  | 4.8x  |  
| trafilatura 1.2.2 (precision)  | 0.874  | 0.905  | 0.902  | 9.4x  |  
| trafilatura 1.2.2 (standard)  | 0.914  | 0.904  | 7.1x  |  
...
| --- |  
| Python Package  | Precision  | Recall  | Accuracy  | F-Score  | Diff.  |  
| _raw HTML_  | 0.527  | 0.878  | 0.547  | 0.659  |  
| html2text 2020.1.16  | 0.488  | 0.714  | 0.484  | 0.580  | 8.9x  |  
| html_text 0.5.2  | 0.526  | 0.548  | 0.679  | 1.9x  |  
| inscriptis 1.1 (html to txt)  | 0.531  | 0.556  | 0.683  | 2.4x  |  
...
| goose3 3.1.9  | 0.644  | 0.806  | 0.767  | 18.8x  |  
| _baseline (text markup)_  | 0.746  | 0.804  | 0.766  | 0.774  |  
| dragnet 2.0.4  | 0.906  | 0.689  | 0.810  | 0.783  | 3.1x  |  
| readability-lxml 0.8.1  | 0.917  | 0.716  | 0.826  | 0.804  | 5.9x  |  
| news-please 1.5.21  | 0.924  | 0.718  | 0.830  | 0.808  |  
| trafilatura 0.8.2 (fast)  | 0.925  | 0.868  | 0.899  | 0.896  | 3.9x  |  
| trafilatura 0.8.2  | 0.934  | 8.4x  |  
...
| newspaper3k 0.2.8  | 0.921  | 0.574  | 0.763  | 0.708  | 12.9x  |  
| goose3 3.1.6  | 0.629  | 0.799  | 0.757  | 19.0x  |  
| boilerpy3 1.0.2 (article mode)  | 0.851  | 0.696  | 0.788  | 0.766  | 4.8x  |  
| _baseline (text markup)_  | 0.746  | 0.804  | 0.766  | 0.774  |  
| dragnet 2.0.4  | 0.906  | 0.689  | 0.810  | 0.783  | 3.1x  |  
| readability-lxml 0.8.1  | 0.917  | 0.716  | 0.826  | 0.804  | 5.9x  |  
...
| trafilatura 0.6.0 (+ fallbacks)  | 0.933  | 8.4x  |  
...
| trafilatura 0.5.1 (+ fallbacks)  | 0.933  | 0.885  | 6.8x  |  
...
| trafilatura 0.4 (+ fallback)  | 0.925  | 0.904  | 9.94  |  
...
| --- |  
| Python Package  | Precision  | Recall  | Accuracy  | F-Score  | Time  |  
| _raw HTML_  | 0.492  | 0.902  | 0.511  | 0.637  |  
| inscriptis 1.0 (html to txt)  | 0.504  | 0.532  | 0.668  | 0.87  |  
| justext 2.2.0 (German stoplist)  | 0.886  | 0.553  | 0.754  | 0.681  | 2.22  |  
| goose3 3.1.6  | 0.594  | 0.787  | 0.726  | 7.64  |  
...
| trafilatura 0.3.1 (+ justext)  | 0.889  | 0.936  | 2.19  |  
### This Page
