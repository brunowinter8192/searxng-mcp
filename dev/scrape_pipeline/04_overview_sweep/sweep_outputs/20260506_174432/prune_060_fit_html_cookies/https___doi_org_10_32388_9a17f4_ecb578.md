...
SMOG=+3SMOG=polysyllablecount+3
Dale Chall0.1579×(PWD)0.0496(ASL)3.6365Dale Chall=0.1579×(PWD)+0.0496×(ASL)+3.6365
Spache=0.141×(ASL)+0.086×+0.839
...
| --- | --- | --- |  
| Percentage of Difficult words (with isalpha and Minmax Scaling) |  |  |  
| Percentage of Difficult words (with isalpha and without Minmax Scaling) |  |  |  
| Percentage of Difficult words (without isalpha and Minmax Scaling) |  |  |  
| Percentage of Difficult words (without isalpha and without Minmax Scaling) |  |  |  
