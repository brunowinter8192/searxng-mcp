...
Some fixes could be needed for a few patterns found in these webpages (partly addressed in and ), that said text extraction remains a balancing act... I added a few pages to the evaluation, things should get slightly better by the next release.
...
added 
Further information is requested
**to join this conversation on GitHub.** Already have an account? [Sign in to comment](https://github.com/login?return_to=https://github.com/adbar/trafilatura/issues/25)
## Metadata
## Metadata
Further information is requested
## Issue actions
