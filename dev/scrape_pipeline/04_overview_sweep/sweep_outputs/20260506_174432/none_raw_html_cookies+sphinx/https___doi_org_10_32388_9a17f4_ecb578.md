...
[![Qeios](https://www.qeios.com/images/brand/Qeios.svg) ![Qeios](https://www.qeios.com/images/brand/Q.svg)](https://www.qeios.com)
![Search](https://www.qeios.com/images/icons/search/lens.svg)
[Peer-approved](https://www.qeios.com/peer-approved-articles) [Preprints](https://www.qeios.com/preprints) [Archive](https://www.qeios.com/archive)
  * [About](https://www.qeios.com/about)
  * [Ethics](https://www.qeios.com/ethics)
  * [Plans](https://www.qeios.com/plans)
  * [Sign Up Free](https://www.qeios.com/signup)
  * [Log in](https://www.qeios.com/login)
...
![Views](https://www.qeios.com/images/icons/eye.svg)
888
![Downloads](https://www.qeios.com/images/icons/download_lightgrey.svg)
366
![Peer reviewers](https://www.qeios.com/images/icons/review_lightgrey.svg)
0
![Citations](https://www.qeios.com/images/icons/citations_lightgrey.svg)
0
![Make action](https://www.qeios.com/images/icons/dot_menu.svg)
[![](https://www.qeios.com/images/icons/download_blue.svg) PDF ](https://www.qeios.com/read/9A17F4/pdf) Cite ![](https://www.qeios.com/images/icons/history.png)
![](https://www.qeios.com/images/icons/share.png)
### Field
Computer Science
### Subfield
...
[Rajeshwari Satrasala](https://www.qeios.com/profile/102628)1, [Kushal Shah](https://www.qeios.com/profile/31151)1[![](https://www.qeios.com/images/icons/orcid.svg)](https://orcid.org/0000-0003-3398-8425)
###  Affiliations ![](https://www.qeios.com/images/icons/arrow_down.svg)
Declarations
...
SMOG=𝑝𝑜𝑙𝑦𝑠𝑦𝑙𝑙𝑎𝑏𝑙𝑒𝑐𝑜𝑢𝑛𝑡‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾√+3(1a)(1a)SMOG=polysyllablecount+3
Dale Chall=0.1579×(PWD)+0.0496×(ASL)+3.6365(1b)(1b)Dale Chall=0.1579×(PWD)+0.0496×(ASL)+3.6365
Spache=0.141×(ASL)+0.086×(PWD)1+0.839(1c)(1c)Spache=0.141×(ASL)+0.086×(PWD)1+0.839
In Eq. (1a), the polysyllable count is the number of words of more than two syllables in a sample of 30 sentences. In Eq. (1b), ASL means Average Sentence Length, PWDPWD is the percentage of difficult words not part of the Dale Chall common word list, and in (1c) PWD1PWD1 is the percentage of difficult words not part of the Spache common word list.
In this paper, the standard Brown corpus[[6]](https://www.qeios.com/read/9A17F4#DRUhyb3QVj7l) and Baby BNC[[7]](https://www.qeios.com/read/9A17F4#UAuniSbgY2yN) datasets are used to create the corpus for the fiction and non-fiction classification task. The detailed analysis is presented in the following sections.
## II. Corpus creation
...
In Table I, classification results based on Dale-Chall, Spache, and SMOG readability scores are tabulated. The “Dale-Chall score" alone gives 94%% test accuracy on the Brown and 99%% test accuracy on the Baby BNC corpus. These results are almost comparable with the two feature-based results proposed in[[1]](https://www.qeios.com/read/9A17F4#vun6Z7Q0m1PJ).
...
Here are some of our key findings from the above experiments on the BERT model:
  ...
  3. Even as low as 5 random words out of 300 to 350 input words are sufficient for BERT to provide approximately 79%79% accuracy. As the number of words increases, the accuracy of the BERT model increases.
...
In this paper, we have shown that fiction vs non-fiction genre classification can be achieved with very high accuracy using the percentage of difficult words in a text. Although this accuracy value is similar to that obtained using the two ratio features (adverb/adjective and adjective/pronoun)[[1]](https://www.qeios.com/read/9A17F4#vun6Z7Q0m1PJ), an advantage of using the difficult words percentage is that it is easier to relate to. We do expect non-fiction texts to have a higher percentage of difficult words as compared to fiction texts.
...
## References
  1. [a](https://www.qeios.com/read/9A17F4#svhPF13XBE8g), [b](https://www.qeios.com/read/9A17F4#v2hW4Gg4Hr8M), [c](https://www.qeios.com/read/9A17F4#bhgfALUdB5t4), [d](https://www.qeios.com/read/9A17F4#m0THA427figu), [e](https://www.qeios.com/read/9A17F4#qjmMw10uqlAE)Qureshi R, Ranjan S, Rajkumar R, Shah K. (2019). "A simple approach to classify fictional and non-fictional genres". Association for Computational Linguistics, Proceedings of the Second Workshop on Storytelling. :81–89.
  2. [a](https://www.qeios.com/read/9A17F4#ogGiCf8H0cTU), [b](https://www.qeios.com/read/9A17F4#UrG1Ikp5ZjFu)Vicente M, Miró Maestre M, Lloret E, Suárez Cueto A. (2021). "Leveraging machine learning to explain the nature of written genres". IEEE Access. 9:24705–24726.
  3. [a](https://www.qeios.com/read/9A17F4#AJ2WpY9M9LWq), [b](https://www.qeios.com/read/9A17F4#bR6w3M8jjy65), [c](https://www.qeios.com/read/9A17F4#lV43W1rhmhxo)Kazmi A, Ranjan S, Sharma A, Rajkumar R. (2022). "Linguistically motivated features for classifying shorter text into fiction and non-fiction genre". In: Proceedings of the 29th international conference on computational linguistics. International Committee on Computational Linguistics pp. 922–937.
  4. [^](https://www.qeios.com/read/9A17F4#xRe2liajfRxg)Readability. Available from: https://en.wikipedia.org/wiki/Readability
  5. [^](https://www.qeios.com/read/9A17F4#9K6c0SbWoYNx)Readability index in python(NLP). Available from: https://www.geeksforgeeks.org/readability-index-pythonnlp/
  6. [^](https://www.qeios.com/read/9A17F4#ShzK9heEUMbp)Francis WN, Kučera H. (1989). "Manual of information to accompany a standard corpus of present-day edited american english: For use with digital computers". Brown University, Department of Linguistics.
  7. [^](https://www.qeios.com/read/9A17F4#UzD18hgZwjnq)BNCConsortium. (2007). "British national corpus, baby edition". Oxford Text Archive.
  8. [^](https://www.qeios.com/read/9A17F4#KYNsDRGhlyZl)Qi P, Zhang Y, Zhang Y, Bolton J, Manning CD. (2020). "Stanza: A python natural language processing toolkit for many human languages". Association for Computational Linguistics (ACL) System Demonstrations.
  9. [^](https://www.qeios.com/read/9A17F4#oxfIpr0cQdb0)Common words acoording to dale chall. Available from: https://help.readable.com/en/article/dale-chall-words-list-w877fe/?_ga=2.128864650.789442227.1731919731-2055000836.1731919731
  10. [^](https://www.qeios.com/read/9A17F4#Pd8Ot9IiBsUY)Common words acoording to spache. Available from: https://help.readable.com/en/article/what-is-the-spache-words-list-1mxg9cb/


## Open Peer Review
Review this Article Review it
![](https://www.qeios.com/images/gifs/eclipse-loader.gif)
![](https://www.qeios.com/images/brand/Qeios.svg)
  * [Editorial Team](https://www.qeios.com/about#editorial-team)
  * [Conduct Policy](https://www.qeios.com/conduct-policy)
  * [Publishing Policy](https://www.qeios.com/publishing-policy)
  * [Archive](https://www.qeios.com/archive)
  * [Terms](https://www.qeios.com/terms)
  * [Privacy](https://www.qeios.com/privacy)
  * Contact Us

[Follow at @qeios](https://twitter.com/intent/follow?user_id=783599340833169408)
© 2026 Qeios Ltd. London (UK).  |  ISSN 2632-3834  |  Indexed in [Google Scholar](https://scholar.google.com/) and [Europe PMC](https://europepmc.org/About)  |  Archived in [Portico](https://www.portico.org/) and [The British Library](https://www.bl.uk/)  |  [COPE](https://publicationethics.org/) member  |  ![Open Access](https://www.qeios.com/images/icons/open_access_logo_grey.svg)
